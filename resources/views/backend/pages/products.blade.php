                            ...
                            <div class="col-lg-8 offset-lg-2 col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal mt-4" action="{{route('admin.shop.addProduct')}}" method="POST">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="price" name="price" class="form-control" placeholder="Product Price with symbol like $" required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                @if (count($products) > 0)
                                                    @foreach ($products as $product)
                                                        <tr>
                                                            ...
                                                            <td>{{$product->name}}</td>
                                                            <td>{{$product->shop_category_id}}</td>
                                                            <td>{{$product->price}}</td>
