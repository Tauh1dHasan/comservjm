                            ...
                            <div class="col-lg-8 offset-lg-2 col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal mt-4" action="{{route('admin.shop.addCategory')}}" method="POST">
                                            @csrf
                                                ...
                                                @if (count($categories) > 0)
                                                    @foreach ($categories as $category)
                                                        <tr>
                                                            ...
                                                            <td>{{$category->name}}</td>
                                                            <td>
                                                                <a href="{{route('admin.shop.deleteCategory', $category->id)}}" class="btn btn-danger btn-sm">Delete</a>
                                                            </td>
                                                        </tr>
                                                        @php
                                                            $i++;
